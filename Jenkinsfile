                    ...
                    if (msg) {
                        ...
                        if (allTaskIds) {
                            allTaskIds.each { taskId ->
                                ...
                                build job: 'fedora-ci/dit-git-pipeline/master', wait: false, parameters: [ string(name: 'ARTIFACT_ID', value: artifactId), string(name: 'ADDITIONAL_ARTIFACT_IDS', value: additionalArtifactIds) ]
                            }
                        }
                    }
                }
